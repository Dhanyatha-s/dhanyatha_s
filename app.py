...
def send_email():
    ...
    # Replace these with your actual EmailJS service, template IDs, user ID, and private key
    service_id = 'service_315c41f'
    template_id = 'template_kpu4zqf'
    user_id = 'MeJPU2wl9CMY-blgZ'
    private_key = 'HDIlNXigmJkci5Tu-yJQd'  # Replace this with your actual private key
    ...
    payload = {
        ...
        'accessToken': private_key  # Include the private key here
    }
